...
import { StudentService } from '../../services/candidate/student.service'; // Adjust the path as needed
import { Student } from '../../services/candidate/student.service'; // Adjust the path as needed
import {FormControl, FormGroup, FormsModule, ReactiveFormsModule, Validators} from '@angular/forms';
import {BreadcrumbModule} from "primeng/breadcrumb";
import {MenuItem, MessageService} from "primeng/api";
import {CandidateServiceService} from "../../services/candidate/candidate-service.service"; // Import FormsModule

@Component({
  selector: 'app-it',
  standalone: true,
  imports: [FormsModule, BreadcrumbModule, ReactiveFormsModule],
